	...
	render() {
		return (
			<React.Fragment>
										...
										<div className="tt-description">
											<div className="tt-description-wrapper">
												...
												<div className="tt-title-large">
													GET UP TO <span className="tt-base-color">20% OFF</span>
												</div>
											</div>
										</div>
									</Link>
									...
									<Link to="listing-left-column.html" className="tt-promo-box">
										...
										<div className="tt-description">
											<div className="tt-description-wrapper">
												...
												<div className="tt-title-large">
													GET UP TO <span className="tt-base-color">50% OFF</span>
												</div>
											</div>
										</div>
									</Link>
										...
										<div className="tt-description">
											<div className="tt-description-wrapper">
												...
												<div className="tt-title-small">
													SUMMER <span className="tt-base-color">2018</span>
												</div>
									...
									<Link to="listing-left-column.html" className="tt-promo-box">
										...
										<div className="tt-description">
											...
											<div className="tt-description-wrapper">
												...
												<div className="tt-title-large">
													<span className="tt-base-color">HANDBAGS</span>
												</div>
											</div>
										</div>
									</Link>
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img
																src="assets/images/product/product-18-02.jpg"
																data-src=""
																alt=""
															/>
														</span>
												...
												<div className="tt-description">
													...
													<h6 className="tt-title">
														<Link to="#">Flared Shift Dress</Link>
													</h6>
													<div className="tt-price">$24</div>
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-19-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-20-01.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-22-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-23-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
													...
													<div className="tt-option-block">
														<ul className="tt-options-swatch">
															<li>
																<Link className="options-color tt-color-bg-03" to="#" />
															</li>
															<li>
																<Link className="options-color tt-color-bg-04" to="#" />
															</li>
															<li>
																<Link className="options-color tt-color-bg-05" to="#" />
															</li>
														</ul>
													</div>
												</div>
										...
										<div className="tt-item">
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														<span className="tt-img-default">
															<img src="assets/images/product/product-21.jpg" alt="" />
														</span>
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-21-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-16-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
											...
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-12-01.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
													...
													<div className="tt-price">$178</div>
												</div>
											</div>
										</div>
										<div className="tt-item">
											<div className="tt-layout-vertical">
												<div className="tt-img">
													<Link to="listing-collection.html">
														...
														<span className="tt-img-roll-over">
															<img src="assets/images/product/product-13-02.jpg" alt="" />
														</span>
													</Link>
												</div>
												<div className="tt-description">
				...
				<Link to="#" className="tt-back-to-top">
					BACK TO TOP
				</Link>
								...
								<div className="tt-modal-addtocart desctope">
									<div className="row">
										...
										<div className="col-12 col-lg-6">
											...
											<Link to="shopping_cart_02.html" className="btn btn-border">
												VIEW CART
											</Link>
											...
											<div className="tt-product-single-info">
												<div className="tt-add-info">
													<ul>
														...
														<li>
															<span>Availability:</span> 40 in Stock
														</li>
													</ul>
												</div>
														...
														<ul className="tt-options-swatch options-large">
															<li>
																<Link className="options-color" to="#">
																	<span className="swatch-img">
																		<img
																			src="assets/images/custom/texture-img-01.jpg"
																			alt=""
																		/>
																	</span>
															...
															<li className="active">
																<Link className="options-color" to="#">
																	<span className="swatch-img">
																		<img
																			src="assets/images/custom/texture-img-02.jpg"
																			alt=""
																		/>
																	</span>
																	<span className="swatch-label color-black" />
															...
															<li>
																<Link className="options-color" to="#">
																	<span className="swatch-img">
																		<img
																			src="assets/images/custom/texture-img-03.jpg"
																			alt=""
																		/>
																	</span>
																	<span className="swatch-label color-black" />
															...
															<li>
																<Link className="options-color" to="#">
																	<span className="swatch-img">
																		<img
																			src="assets/images/custom/texture-img-04.jpg"
																			alt=""
																		/>
																	</span>
																	<span className="swatch-label color-black" />
															...
															<li>
																<Link className="options-color" to="#">
																	<span className="swatch-img">
																		<img
																			src="assets/images/custom/texture-img-05.jpg"
																			alt=""
																		/>
																	</span>
																	<span className="swatch-label color-black" />
