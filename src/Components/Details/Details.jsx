...
const Details = props => {
    console.log("Detailsssssssssssssss ", props);
    return(
...
// 			</div>
// 				<div className="tt-carousel-products row arrow-location-right-top tt-alignment-img tt-layout-product-item slick-animated-show-js">
...
// 								<span className="tt-img"><img src="images/product/product-16.jpg" alt="" /></span>
// 								<span className="tt-img-roll-over"><img src="images/product/product-16-02.jpg" alt=" /" /></span>
// 							</Link>
// 						</div>
...
// 							<Link to="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></Link>
// 							<Link to="product.html">
// 								<span className="tt-img"><img src="images/product/product-17.jpg" alt="" /></span>
// 								<span className="tt-img-roll-over"><img src="images/product/product-17-01.jpg" alt=" /" /></span>
// 							</Link>
// 						</div>
// 						<div className="tt-description">
// 							<div className="tt-row">
...
// 							<Link to="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></Link>
// 							<Link to="product.html">
// 								<span className="tt-img"><img src="images/product/product-18.jpg" alt="" /></span>
// 								<span className="tt-img-roll-over"><img src="images/product/product-18-02.jpg" alt=" /" /></span>
// 							</Link>
// 						</div>
// 						<div className="tt-description">
// 							<div className="tt-row">
...
// 							<Link to="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></Link>
// 							<Link to="product.html">
// 								<span className="tt-img"><img src="images/product/product-19.jpg" alt="" /></span>
// 								<span className="tt-img-roll-over"><img src="images/product/product-19-02.jpg" alt=" /" /></span>
// 							</Link>
// 						</div>
// 						<div className="tt-description">
// 							<div className="tt-row">
...
// 							<Link to="#" className="tt-btn-compare" data-tooltip="Add to Compare" data-tposition="left"></Link>
// 							<Link to="product.html">
// 								<span className="tt-img"><img src="images/product/product-14.jpg" alt="" /></span>
// 								<span className="tt-img-roll-over"><img src="images/product/product-14-02.jpg" alt=" /" /></span>
// 							</Link>
// 						</div>
// 						<div className="tt-description">
// 							<div className="tt-row">
