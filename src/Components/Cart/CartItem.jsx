                    ...
                    <tbody>
                        {
                            props.items.map( item =>(
                                <tr key={item._id}>
                            <td>
                                <Link to="#" className="tt-btn-close" onClick={() => props.removeItem(item)}></Link>
                            </td>
                            <td>
                            ...
                            <td>
                                <div className="detach-quantity-desctope">
                                    <div className="tt-input-counter style-01">
                                        <span className="minus-btn" onClick={ ()=>props.decrease(item)}></span>
                                        <input type="text" value={item.qty} size="5" />
                                        <span className="plus-btn" onClick={ ()=>props.increase(item)}></span>
                                    </div>
                                </div>
                            </td>
                            <td>
